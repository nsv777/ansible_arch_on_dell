...
hl.bind(mainMod .. " + CTRL + left", function() hl.dispatch("movewindow", "l") end)
hl.bind(mainMod .. " + CTRL + right", function() hl.dispatch("movewindow", "r") end)
hl.bind(mainMod .. " + CTRL + up", function() hl.dispatch("movewindow", "u") end)
hl.bind(mainMod .. " + CTRL + down", function() hl.dispatch("movewindow", "d") end)
